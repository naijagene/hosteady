...
readonly class DocumentOcrResult implements \JsonSerializable
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            ocrText: isset($data['ocr_text']) ? (string) $data['ocr_text'] : (isset($data['ocrText']) ? (string) $data['ocrText'] : null),
