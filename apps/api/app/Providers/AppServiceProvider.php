...
use App\Policies\ThemeDefinitionPolicy;
use App\Policies\PersonalizationProfilePolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(ThemeDefinition::class, ThemeDefinitionPolicy::class);
        Gate::policy(PersonalizationProfile::class, PersonalizationProfilePolicy::class);
