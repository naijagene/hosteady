...
| ALPHA-012 | Demo data | `AlphaDemoSeeder` is section-idempotent; re-run after migrations | Workflow samples still manual | `php artisan db:seed --class=AlphaDemoSeeder` | Alpha A1 |
